[
  _this,
  "<t color='#FF1919'>Опастность перегрева!\n%1м%2с до номинальной температуры</t>",
  ...
  "<t color='#19FF19'>Осталось использований: %1</t>",
  {
    ...
    if (time >= _time) exitWith {
      hint parseText "<t color='#FF1919'>Опастность перегрева!</br>Скорость выработки топлива восстановлена.</t>";
    };
  }, {
    private _jps = getArray (_cfg >> "jumppacks");
    if not (backpack player in _jps) exitWith {
